...
namespace SpaceMauraders.World
{
    public class Pathfinding
    {
        ...
        public  List<Node> FindPath(Node start, Node goal)
        {
            ...
            while(lookingForPath)
            {
               ...
               // Console.WriteLine("node position " + currentNode.arrayPosition); 
                ...
                var adjacentNodes = GetWalkableAdjacentSquares(currentNode.arrayPosition.X, currentNode.arrayPosition.Y, Game1.world.spaceStation.nodeMesh.GetMap());
                //Console.WriteLine("NUMBER OF ADJACENT NODES: " + adjacentNodes.Count);
        ...
        static List<Node> GetWalkableAdjacentSquares(int x, int y, Node[,] map)
        {
            ...
            if(Game1.world.spaceStation.nodeMesh.GetNode(x - 1,y) != null)
            {
                proposedLocations.Add(Game1.world.spaceStation.nodeMesh.GetNode(x - 1, y));
            }
            ...
            if (Game1.world.spaceStation.nodeMesh.GetNode(x, y - 1) != null )
            {
                proposedLocations.Add(Game1.world.spaceStation.nodeMesh.GetNode(x, y - 1));
            }
            ...
            if (Game1.world.spaceStation.nodeMesh.GetNode(x + 1, y + 1 ) != null  )
            {
                proposedLocations.Add(Game1.world.spaceStation.nodeMesh.GetNode(x + 1, y + 1));
            }
